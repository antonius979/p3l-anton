    ...
    <v-main class="list">
        ...
        <v-dialog v-model="dialog" persistent max-width="600px">
            <v-card>
                ...
                <v-card-text>
                    <v-container>
                        <v-text-field v-model="form.id_instruktur" :rules="rules.id_instruktur" outlined dense label="Instruktur" required></v-text-field>
...
export default {
    ...
    data() {
        return {
            ...
            // jam: ['I (08.00 - 15.00)', 'II (15.00 - 22.00)'],
