<template>
    <v-main class="list">
          <h3 class="text-h4 font-weight-bold mb-8 text-center text-decoration-underline"> Data Mobil </h3>
        ...
        <v-card>
            <v-card-title>
                ...
                <v-btn color="success" class="mr-2" dark @click="dialog = true"> Tambah </v-btn>
                <v-btn color="primary" dark @click="kontrakHandler()">Kontrak</v-btn>
