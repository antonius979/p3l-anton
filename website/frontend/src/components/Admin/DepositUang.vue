<template>
    <v-main class="list">
          <h3 class="text-h4 font-weight-bold mb-8 text-center text-decoration-underline"> Data Deposit Uang </h3>
        ...
        <v-card>
            <v-card-title>
                ...
                <v-btn color="success" dark @click="dialog = true"> Tambah Deposit Uang </v-btn>
        ...
        <v-dialog v-model="dialog" persistent max-width="600px">
            <v-card>
                ...
                <v-card-title class="blue lighten-4 justify-center">
                    <span class="headline justify-center">{{ formTitle }} Deposit Uang</span>
                </v-card-title>
                ...
                <v-card-text>
                    <v-container >
                        ...
                        <v-form v-model="valid" ref="form"> 
                            ...
                            <v-text-field v-model="form.aktivasi_tahunan" :rules="rules.aktivasi_tahunan" outlined dense label="Deposit Uang" required></v-text-field>
...
export default {
    ...
    data() {
        return {
            ...
            valid:false,
            headers: [
                { text: "ID Deposit Uang", value: 'id_aktivasi_tahunan '},
                ...
                { text: "Deposit Uang", value: 'aktivasi_tahunan'},
            ],
            //
            rules: {
              id_member  : [
    ...
    methods: {
        ...
        save() {
            this.depositUang.append('id_member', this.form.id_member);
            this.depositUang.append('id_pegawai ', this.form.id_pegawai );
            // this.depositUang.append('tanggal_transaksi', this.form.tanggal_transaksi);
            // this.aktivasiTahunan.append('masa_aktif', this.form.masa_aktif);
            this.depositUang.append('total_deposit', this.form.total_deposit);

            this.depositUang.append('id_role', 'AktivasiTahunan');
        ...
        update() {
            let newData = {
                ...
                sisa_deposit: this.form.sisa_deposit,
                total_deposit: this.form.total_deposit,
                bonus_deposit: this.form.bonus_deposit,
        ...
        deleteData() {
            //menghapus data
            var url = this.$api + '/depositUang/' + this.deleteId;
            this.load = true;
        ...
        editHandler(item) {
            ...
            this.form.sisa_deposit = item.sisa_deposit;
