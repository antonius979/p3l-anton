        ...
        <v-navigation-drawer v-model="drawer" class="fullheight" width="256" app color="#B0C4DE">
            <v-list-item>
                <v-list-item-content>
                    ...
                    <v-spacer></v-spacer>
                    <v-list-item-title class="title_drawer">Welcome {{ nama_customer }}</v-list-item-title>
                </v-list-item-content>
            </v-list-item>
    ...
    export default {
        ...
        data() {
            return {
                drawer: true,
                items: [
                    { title: 'Profil', to: '/profilCustomer', icon:"mdi-account-circle" },
                    { title: 'Peminjaman', to: '/peminjamanCustomer', icon:"mdi-book" },
                    { title: 'Pembayaran', to: '/pembayaranCustomer', icon:"mdi-credit-card-outline" },
                    { title: 'Riwayat Transaksi', to: '/riwayatTransaksiCustomer', icon:"mdi-credit-card-outline" },
                ],
