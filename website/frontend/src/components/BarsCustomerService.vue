<template>
    <div class="dashboard">
        <v-navigation-drawer v-model="drawer" class="fullheight" width="256" app color="#B0C4DE">
            <v-list-item>
                <v-list-item-content>
                    <img src="..\assets\asli.png" width="130" height="180">
                    <v-spacer></v-spacer>
    ...
    export default {
        ...
        data() {
            return {
                drawer: true,
                items: [
                    { title: 'Customer', to: '/CScustomer', icon:"mdi-badge-account-horizontal" },
                    { title: 'Verifikasi Peminjaman', to: '/CSverifpinjam', icon:"mdi-check-decagram" },
                    { title: 'Verifikasi Pembayaran', to: '/CSverifbayar', icon:"mdi-check-decagram" },
                    { title: 'Data Transaksi Customer', to: '/CStampilTransaksi', icon:"mdi-book" },
                ],
