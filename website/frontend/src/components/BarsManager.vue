    ...
    export default {
        ...
        data() {
            return {
                drawer: true,
                items: [
                    // { title: 'Daftar Jadwal', to: '/MdaftarJadwal', icon:"mdi-calendar" },
                    // { title: 'Jadwal Pegawai', to: '/MjadwalPegawai', icon:"mdi-calendar-account" },
                    // { title: 'Promo', to: '/Mpromo', icon:"mdi-sale" },
                    { title: 'Jadwal', to: '/Mjadwal', icon:"mdi-calendar" },
                    { title: 'Jadwal Harian', to: '/MjadwalHarian', icon:"mdi-calendar" },
